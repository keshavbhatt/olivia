$.mobile.document.on( "pagecreate", "#artists_page", function(){
    var head = $( ".ui-page-active [data-role='header']" );

    $.mobile.document.on( "click", "#sorter li", function() {
        var top,
            letter = $( this ).text(),
            divider = $( "#saved_artists_result" ).find( "li.ui-li-divider:contains(" + letter + ")" );
...
$.mobile.document.on( "pageshow", "#artists_page", function() {
