...
public:
  ...
  Q_INVOKABLE void addToQueue(QString id, QString title, QString artist,
  ...
  Q_INVOKABLE void
  addToSimilarTracksQueue(const QVariant Base64andDominantColor);
  ...
  Q_INVOKABLE void playAllLocalSongs();
...
private slots:
  ...
  void radio_demuxer_cache_duration_changed(double,
                                            double radio_playerPosition);
  ...
  void prepareTrack(QString songId, QString query, QString millis,
                    QListWidget *list);
...
private:
  ...
  QString database;
  QString gotoAlbumId, gotoArtistId, recommendationSongId,
      youtubeVideoId; // jumper vars
  QString pageType;
